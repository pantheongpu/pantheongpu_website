...
<p class="page-intro__eyebrow">Fleet validation</p>
...
<div class="pantheon-pilot-card" markdown>

### Request a Free Pilot

Email [saqibkhan@pantheongpu.com](mailto:saqibkhan@pantheongpu.com?subject=PantheonGPU%20Fleet%20Validation%20Pilot) with your GPU type, approximate GPU count, and preferred testing window.

<a href="mailto:saqibkhan@pantheongpu.com?subject=PantheonGPU%20Fleet%20Validation%20Pilot" class="md-button md-button--primary">Request a Free Pilot</a>
</div>

## Run it yourself

PantheonGPU is also available for local evaluation. Start with the [Getting Started guide](getting-started.md), explore the [test documentation](tests/index.md), or review the [public performance database](benchmarks.md).
